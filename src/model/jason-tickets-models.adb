...
package body Jason.Tickets.Models is
   ...
   procedure Reload (Object  : in out Ticket_Ref;
                     Session : in out ADO.Sessions.Session'Class;
   ...
   begin
      ...
      Query.Save_Field (Name  => COL_8_1_NAME, --  update_date
                        Value => Object.Update_Date);
      Query.Save_Field (Name  => COL_9_1_NAME, --  kind
                        Value => Integer (Ticket_Type'Enum_Rep (Object.Kind)));
   ...
   begin
      ...
      if Name = "id" then
         ...
         return Ticket_Type_Objects.To_Object (Impl.Kind);
   ...
   begin
      ...
      Object.Kind := Ticket_Type'Enum_Val (Stmt.Get_Integer (9));
   ...
   procedure Reload (Object  : in out Attribute_Ref;
                     Session : in out ADO.Sessions.Session'Class;
                     Updated : out Boolean) is
      Result : ADO.Objects.Object_Record_Access;
      Impl   : Attribute_Access;
   ...
   procedure List (Object  : in out List_Info_Vector;
      ...
      begin
         ...
         Into.Kind := Ticket_Type'Enum_Val (Stmt.Get_Integer (7));
   ...
   begin
      ...
      Into.Status := Status_Type'Enum_Val (Stmt.Get_Integer (7));
   ...
   begin
      if Name = "comment" then
         ...
         Item.Set_Kind (Ticket_Type_Objects.To_Value (Value));
      elsif Name = "duration" then
